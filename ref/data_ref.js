const personagens = {
  ...
  function personagensCard(personagem) {
    const card = document.createElement('div');
    card.classList.add('personagem-card');
  
    const image = document.createElement('img');
    image.classList.add('personagem-image');
  ...
  const catalogContainer = document.querySelector('.personagem-grid');
  
  personagens.got.forEach(personagem => {
    const card = personagensCard(personagem);
